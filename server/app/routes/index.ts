...
Router.get('/barn/:barnID', async ({ params: { barnID } }, res) => {
  try {
...
Router.patch('/update/:BarnID', async ({ body, params: { BarnID } }, res) => {
...
// Delete a barn
Router.delete('/delete/:BarnID', async ({ params: { BarnID } }, res) => {
  try {
